...
when ODIN_OS == .Windows do foreign import native "RGFW-buffer/libRGFW.dll"
when ODIN_OS == .Darwin do foreign import native "RGFW-buffer/libRGFW.dylib"
when (ODIN_OS == .Linux || ODIN_OS == .FreeBSD || ODIN_OS == .OpenBSD) do foreign import native "RGFW-buffer/libRGFW.so"
